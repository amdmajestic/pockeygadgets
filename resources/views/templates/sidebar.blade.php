    ...
    <aside
        ...
        <div class="min-w-[345px] max-w-[345px] bg-white overflow-x-scroll flex flex-col gap-16 justify-start p-6">
            <label for="smallscreen-menu-toggle"
                class="flex flex-row justify-start sm:justify-end text-3xl cursor-pointer max-h-max max-w-max hover:drop-shadow-md hover:drop-shadow-red-300">
                <span class="iconify hover:text-gray-500 cursor-pointer" data-icon="clarity:window-close-line"
                    data-inline="false"></span>
            </label>

            <ul
                class="[&>*]:py-2 [&>*]:uppercase [&>*]:border-t [&>*]:border-gray-300 w-5/6 ml-4 list-none xl:hidden flex flex-col gap-1">
