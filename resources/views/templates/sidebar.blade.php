{{-- <aside class="sticky top-0 w-full h-[100vh] z-1 flex felx-row justify-between">
    <div class="basis-4/12 bg-white overflow-x-scroll flex flex-col gap-16 justify-start p-6">
        <div class="flex flex-row justify-end text-3xl cursor-pointer">
    ...
    <div class="basis-8/12 bg-black opacity-45"></div>
</aside> --}}
...
<div>
    ...
    {{-- xl:hidden --}}
    <aside
        class="absolute top-0 left-0 w-full h-[100vh] z-1 hidden xl:peer-checked:hidden peer-checked:flex felx-row justify-between">
        <div class="min-w-[345px] max-w-[345px] bg-white overflow-x-scroll flex flex-col gap-16 justify-start p-6">
            <label for="smallscreen-menu-toggle" class="flex flex-row justify-end text-3xl cursor-pointer">
